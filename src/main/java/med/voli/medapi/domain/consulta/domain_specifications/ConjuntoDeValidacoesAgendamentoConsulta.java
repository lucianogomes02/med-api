package med.voli.medapi.domain.consulta.domain_specifications;

import med.voli.medapi.domain.consulta.domain_specifications.validation_interfaces.ConjuntoDeValidacoesDeAgendamentoConsultaInterface;
import med.voli.medapi.domain.consulta.domain_specifications.validation_interfaces.ValidadorAgendamentoConsultaInterface;
import med.voli.medapi.domain.consulta.domain_specifications.validators.ValidadorHorarioFuncionamentoClinica;
import med.voli.medapi.domain.consulta.domain_specifications.validators.ValidadorMedicoAgendamentoDeConsulta;
